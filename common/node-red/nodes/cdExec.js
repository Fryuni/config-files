...
module.exports = function (RED) {
  ...
  function ExecNode(n) {
    ...
    this.execOpt = { cwd: n.cwd || process.cwd(), encoding: 'binary', maxBuffer: RED.settings.execMaxBufferSize || 10000000, windowsHide: (n.winHide === true) };
    this.spawnOpt = { cwd: n.cwd || process.cwd(), windowsHide: (n.winHide === true) }
    var node = this;
  ...
  RED.nodes.registerType("cdExec", ExecNode);
}
