# DO NOT EDIT! This file is generated automatically by update.mjs
{
  ...
  cargo-expand = {
    crateSha256 = "sha256-izqkkQl28K5Tr01UGk0/lYBEbkQlRAMjRM90W7C7K+I=";
    depsHash = "sha256-479FaYMadSjWkJ/V+y+isS+tdyWA29g//6B/7Yg6wJA=";
  ...
  cargo-sort = {
    ...
    depsHash = "sha256-6Nxy2s0hXQqwCz82Xc1U10cYn6NdOqEX6JNXMrqIJOo=";
  ...
  octorus = {
    crateSha256 = "sha256-x84WMi+7AAcecZW+uYySKpNzszOYpFMXM+OVmF80Fdc=";
    depsHash = "sha256-xzgKgKZhXDJ8mhhiXVC7gYgZABCsNmqmUXKWWYaR22o=";
  ...
  zellij = {
    crateSha256 = "sha256-WKwI493DjSig9f+nRJu0YHNVKb9dwr0lIvVAvWawa8k=";
    depsHash = "sha256-WLLwLb+2DQqf5z5FX0vFdELccX8Fu75hq2h+yLK+Ks8=";
