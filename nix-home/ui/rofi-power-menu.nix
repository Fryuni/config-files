...
with pkgs; let
  rofi-power-menu = writeShellScriptBin "rofi-power-menu" ''
    ...
    all=(shutdown reboot hibernate logout)
    ...
    while true; do
        case "$1" in
            "-h"|"--help")
                ...
                echo "                     as the separator. Available choices are logout,"
                echo "                     hibernate, reboot and shutdown. By default, all"
                echo "                     available choices are shown."
                echo "  --confirm CHOICES  Require confirmation for the gives choices only. Use / as"
                echo "                     the separator. Available choices are logout,"
                echo "                     hibernate, reboot and shutdown. By default, only"
                ...
                echo "                     Available choices are logout,"
